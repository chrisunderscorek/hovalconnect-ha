...
ENTITY_NAMES: dict[str, dict[str, str]] = {
    LANGUAGE_DE: {
        ...
        "current_energy_output": "Aktuelle Wärmeleistung",
        "current_power_output": "Aktuelle Leistung Station",
        "total_performance_factor": "Arbeitszahl gesamt",
    ...
    LANGUAGE_EN: {
        ...
        "current_energy_output": "Current heat output",
        "current_power_output": "Actual power station",
        "total_performance_factor": "Total performance factor",
