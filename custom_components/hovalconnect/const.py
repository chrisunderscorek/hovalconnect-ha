...
REQUEST_RETRY_WINDOW_SECONDS = max(5.0, UPDATE_INTERVAL_SECONDS / 2)
REQUEST_RETRY_MIN_RETRIES = 1
REQUEST_RETRY_BACKOFF_SECONDS = (2, 5, 8)
RETRYABLE_HTTP_STATUS_CODES = {429, 500, 502, 503, 504, 599}
